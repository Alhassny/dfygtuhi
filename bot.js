...
const ids = process.env.IDS || ["449313863494664214", "430757935753461761"]
...
client.on('ready', () => {
    console.log(`Created By: frfse`);
    console.log(`Developed By: ! Abdulrhman with ♥`);
    console.log(`Customer Number كستالاف`);
...
const devs = ["449313863494664214", "430757935753461761"];
